...
import { GestionarAsginaturasPracticasPregradoRoutingModule } from './gestionar-asginaturas-practicas-pregrado-routing.module';
...
@NgModule({
    ...
    imports: [
        CommonModule,
        GestionarAsginaturasPracticasPregradoRoutingModule,
        ComponentsModule,
        PrimeNgModule,
    ],
})
export class GestionarAsginaturasPracticasPregradoModule {}
