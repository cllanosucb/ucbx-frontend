...
@Component({
    selector: 'app-gi-retiros-estudiantes',
    templateUrl: './gi-retiros-estudiantes.component.html',
    styleUrls: ['./gi-retiros-estudiantes.component.scss'],
})
export class GiRetirosEstudiantesComponent implements OnInit {
    asemestre: Rsemestre;
    error: Error = {
        ok: false,
        error: {
    ...
    verificarDatos() {
        ...
        if (this.asemestre == null) {
            ...
            this.retirosEstudiantes();
        }
    }

    retirosEstudiantes() {
        this.usuariosService
            .retirarEstudiantesPregrado(
    ...
    nextPage() {
        this.router.navigate([
            'index/gestionarInscripciones/pregrado/inscripcionesEstudiantes',
        ]);
    }
}
